...
@interface SegementViewController () <UIScrollViewDelegate, SegmentControlDelegate>
...
- (void)viewDidLoad {
    ...
    SegmentControl *segmentedControl = [SegmentControl segmentWithFrame:(CGRect){0, 0, 170, 25} titles:[self titles] tClick:^(NSInteger index) {
...
- (void)segmentedValueDidChange:(SegmentControl *)segment selectIndex:(NSInteger)selectIndex {
    //    NSLog(@"segmentedValueDidChange1---%zd", selectIndex);
}
// segmented点击的时候调用，selectIndex：选中的index，fromeIndex：从哪个index点过来的
- (void)segmentedValueDidChange:(SegmentControl *)segment selectIndex:(NSInteger)selectIndex fromeIndex:(NSInteger)fromeIndex {
...
- (void)segmentedValueDidChange:(SegmentControl *)segment selectIndex:(NSInteger)selectIndex fromeIndex:(NSInteger)fromeIndex selectButton:(UIButton *)selectButton {
...
- (void)segmentedValueDidChange:(SegmentControl *)segment selectIndex:(NSInteger)selectIndex fromeIndex:(NSInteger)fromeIndex selectButton:(UIButton *)selectButton allButtons:(NSArray *)allButtons {
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    SegmentControl *segmentedControl = (SegmentControl *)self.navigationItem.titleView;
